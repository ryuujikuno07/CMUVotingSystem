...
<head>
    ...
    <title>Print Voters Not Voted | CMU Election System</title>
            ...
            <div class="col-xs-12">
              <div class="panel panel-default">
                  <div class="panel-heading">
                      <h3 class="text-center"><strong>List of Voters Actually Not Voted</strong></h3>
                  </div>
                  <div class="panel-body">
                    <table class="table table-condensed" id="tbl_voters2">
                        <thead>
                            <tr>

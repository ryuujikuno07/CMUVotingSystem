...
<head>
    ...
    <title>Print Voters Who Voted | CMU Election System</title>
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="text-center">
                    <h3>
                      <img src="../../img/logodaw.png" alt="Voting System" style="width:60px; height:50px;"> City of Malabon University
                        <br>
                ...
                <div class="invoice-title">
                    <h3>
                        VOTERS CANVASSING REPORT <br/> <strong id="term"></strong>
                    </h3>
                    <h4 class="pull-right">
                        <span id="time"></span>
                    </h4>
                    ...
                    <table class="table table-condensed" id="tbl_voters">
                        <thead>
                            <tr>
                                ...
                                <td><strong>Date and Time of Vote</strong></td>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>

...
<head>
    ...
    <title>CMU Election System || Print Position List</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="position-list.php">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="position-list.php"><i class="fa fa-times"></i> Close</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="invoice-title">
                    <h3>
                        List of Positions <br /> <strong id="term"></strong>
                    </h3>
                    <h4 class="pull-right">
                        <span id="time"></span>
                    </h4>
                    <br>
                    <strong class="pull-right">Vote For *1 = ( Check )
                                                                    *0 = ( Unchecked )</strong> 
                </div>
                <div class="row">
                    <div class="col-xs-12">
                        <table id="tbl_position" class="table table-striped">
                               <thead>
                                    <tr role="row">
    ...
    <script type="text/javascript" src="../../js/position-print.js"></script>

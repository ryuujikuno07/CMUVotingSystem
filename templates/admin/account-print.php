...
<head>
    ...
    <title>CMU Election System || Print User Account</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="user-account-list.php">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="user-account-list.php"><i class="fa fa-times"></i> Close</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table id="tbl_user_account" class="table table-striped">
                        <thead>
                            <tr role="row">
                                <th>
                                    Name
    ...
    <script type="text/javascript" src="../../js/useraccount-print.js"></script>

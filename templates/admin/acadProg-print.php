...
<head>
    ...
    <title>CMU Election System || Print Course List</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top " role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="academic-program-list.php">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="academic-program-list.php"><i class="fa fa-times"></i> Close</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table id="tbl_courses" class="table table-striped">
                               <thead>
                                    <tr role="row">
                                         <th>
                                            Program Name
    ...
    <script type="text/javascript" src="../../js/courses-print.js"></script>

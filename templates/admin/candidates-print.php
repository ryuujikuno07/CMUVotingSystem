...
<head>
    ...
    <title>CMU Election System || Print Candidate List</title>
...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="candidates-list.php">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="candidates-list.php"><i class="fa fa-times"></i> Close</a>
                </li>
            </ul>
        </div>
    </nav>
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="invoice-title">
                    <h3>
                        List of Candidates <br /> <strong id="term"></strong>
                    </h3>
                    <h4 class="pull-right">
                        <span id="time"></span>
                    </h4>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table id="tbl_candidates" class="table table-striped">
                       <thead>
                            <tr role="row">
                                <th >
                                    Student ID
    ...
    <script type="text/javascript" src="../../js/candidates-print.js"></script>

...
<head>
    <title>Academic Program | CMU Election System</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <link rel="stylesheet" href="../../lib/plugins/datatables/bootstrap-datatable.css">
...
<body class='contrast-pink without-footer'>
    ...
    <div id='wrapper'>
        ...
        <nav id='main-nav'>
            <div class='navigation'>
                ...
                <ul class='nav nav-stacked' id="LIST">
                    ...
                    <li class='hidden'>
                        <a href='academic-program-list.php' class="in">
                            ...
                            <div class="col-sm-12">
                                <div class="box bordered-box green-border" style="margin-bottom:0;">
                                    <div class="box-header navcolor">
                                        <div class="title"> <i class="icon-table"></i> List of Courses</div>
                                                    ...
                                                    <div class="row datatables-top">
                                                        <div class="col-sm-12 text-right">
                                                            <div class="dataTables_filter" id="DataTables_Table_0_filter">
                                                                <label>Search:
                                                                    <input id="searchValue" name="searchValue" type="text" aria-controls="DataTables_Table_0" style="width: 200px;" class="form-control input-sm alpha" maxlength="40" placeholder="Search... ">
                                                                    <!-- <input onclick="javascript:search_Course()" class="btn btn-sm btn-success" value="search" type="button"> -->
                                                                  <!--  <button onclick="javascript:commandToClear()" class="btn btn-sm ac-btn-block1 bg-blue waves-effect" type="button" data-toggle="modal" data-target="#myModal"><i class="icon-plus"></i>  Add Course</button> -->
                                                                    <a href="acadProg-print.php"class="btn btn-sm ac-btn-bloc bg-blue waves-effect"><i class="icon-print"></i> Print</a>
                                                                    <button onclick="javascript:refresh()" class="btn btn-sm ac-btn-block bg-blue waves-effect" type="button"><i class="icon-refresh"></i> Refresh</button>
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <table class="data-table table table-bordered table-hover  table-striped dataTable" style="margin-bottom:0;" id="tbl_courses" aria-describedby="DataTables_Table_0_info">
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting" >
                                                                Course Name
                                                              ...
                                                              <!--  <th role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 128px;  text-align: center;" aria-label=": activate to sort column ascending"></th>-->
                  ...
                  <div class="modal-dialog modal-md" role="dialog">
                      <div class="modal-content">
                          <div class="modal-header pink-background">
                              ...
                              <h3 class="modal-title" style="color:white;" id="defaultModalLabel">Academic Course Information</h3>
                          </div>
                              ...
                              <div class="row clearfix">
                                  <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-line">
                                          <input id="txtProgramName" nam="txtProgramName" class="form-control alphabets" placeholder="Course Name" maxlength="100" type="text">
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="form-line">
                                            <input id="txtProgramCode" nam="txtProgramCode" maxlength="8" class="form-control alphabets" placeholder="Course Code" type="text">
                                            <span class="help-inline"></span>
                                          </div>
                                      </div>
                          ...
                          <div class="modal-footer" style="margin-top:-20px;">
                            <div class="col-sm-6 col-sm-offset-6">
                              <button onclick="javascript:save();" id="btn-save" type="button" class="btn ac-btn-block3 bg-blue btn-lg waves-effect" ><i class="icon-save"></i> SAVE CHANGES</button>
                              <button type="button" class="btn ac-btn-block1 btn-lg waves-effect" data-dismiss="modal">CLOSE</button>
                          </div>
                        </div>
        ...
        <script type="text/javascript" src="../../js/acad_program.js"></script>

...
function query_courses(){
  ...
  data:{command:"Print_Courses"},
    success:function(e){
      var o=e;
      if(o&&o.programs.length>0)
        for(var r=0;r<o.programs.length;r++){
          var t=o.programs,s='<tr class="odd">                                    <td>'+t[r].course_description+"</td>                                <td>"+t[r].course_code+"</td>                                <td>"+t[r].College+"</td>                                        </tr>";

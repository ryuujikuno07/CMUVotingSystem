...
function query_position(e){
  ...
  data:{command:"Print_Position",Term:e},
    success:function(e){
      var o=e;
      if(o&&o.positions.length>0)
      for(var t=0;t<o.positions.length;t++){
        var d=o.positions[t],
        i='<tr class="odd">                                   <td>'+d.PositionName+"</td>         <!--                          <td style='text-align:center;'>"+d.PositionCode+"</td>                                     <td style='text-align:center;'>"+d.ShortName+"</td>     -->                               <td style='text-align:center;'>"+d.Allowed+"</td>               <!--                     <td style='text-align:center;'>"+d.AllowPerCourses+"</td>                                     <td style='text-align:center;'>"+d.AllowPerCollege+"</td>                                   <td style='text-align:center;'>"+d.AllowPerParty+"</td>                                    <td style='text-align:center;'>"+d.Qualified+"</td>                                    <td style='text-align:center;'>"+d.SortOrder+"</td>   -->                                 <td style='text-align:center;'>"+d.VoteForAll+"</td>                                    <td style='text-align:center;'>"+d.VoteForCourses+"</td>                                 <td style='text-align:center;'>"+d.VoteForCollege+"</td>                                      </tr>";
        $("#tbl_position tbody").append(i),
...
function privilege(e){
  ...
  $(document).ready(function(){
    ...
    $("#current_user").html(e.FullName+" ("+e.GroupName+")"),
      query_position(o.TermID),privilege(e)}),
    $(document).ready(function(){

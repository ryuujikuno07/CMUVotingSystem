...
function query_userGroup(){
	...
	$.ajax({url:"http://"+e+"/cmuvoting/API/index.php",async:!0,type:"POST",crossDomain:!0,dataType:"json",
		data:{command:"Print_UserGroup"},
		success:function(e){
			var o=e;if(o&&o.userGroup.length>0)
			for(var r=0;r<o.userGroup.length;r++){
				var t=o.userGroup,
				s='<tr class="odd">                                    <td>'+t[r].GroupName+"</td>                                    <td>"+t[r].Desc+"</td>                                    </tr>";
				$("#tbl_user_group tbody").append(s)}
...
function privilege(e){
	...
	$(document).ready(function(){
		...
		$("#current_user").html(e.FullName+" ("+e.GroupName+")"),query_userGroup(),privilege(e)}),
	$(document).ready(function(){

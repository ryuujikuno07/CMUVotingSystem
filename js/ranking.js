function get_active_config(){
  ...
  dataType:"json",data:{command:"get_active_config"},
    success:function(t){
      var e=t;
...
function GenerateRankingResult(){
  ...
  async:!0,type:"POST",crossDomain:!0,
  dataType:"json",data:{command:"getCandidatesFinalCanvassing",TermID:e.TermID},
    success:function(e){
      var o=e;
      console.log(o);
      var a="";
      if($("#content2").empty(),
      1!=o.success)return alert(o.msg),
      !1;
      if(o.candidates.length>0)
        for(var n=0;n<t.length;n++){
          var s=t[n];
          a+='<div class="panel panel-default">                                    <div class="panel-heading">                                        <h3 class="text-center"><strong>'+s.PositionName+'</strong></h3>                                    </div>                                    <div class="table-responsive">                                        <table class="table table-condensed" id="tbl_candidate">                                            <thead>                                                <tr>                                                    <td class="text-center"><strong>Name of Candidates</strong>                                                    </td>                                                    <td class="text-center"><strong>Votes Garnered</strong>                                                    </td>                                                </tr>                                            </thead>                                            <tbody style="font-size:25px;">';for(var r=0;r<o.candidates.length;r++){var i=o.candidates[r];s.PositionID==i.PositionID&&(a+="<tr>                                            <td> "+i.CandidateName+' </td>                                            <td class="text-center">'+i.VoteCount+"</td>                                        </tr>",$("#tbl_candidate tbody").append(a))}a+="</tbody>                            </table>                        </div>                    </div> "}
